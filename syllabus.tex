%----------------------------------------------------------------------------
% Course Syllabus for Chemistry 350 (c) 2017 by Dale J. Brugh
...
\hypersetup{
    ...
    pdfkeywords={classes, ch350f17}, % list of keywords
...
\makeoddhead{courseinformation}%
    {\sffamily Course Syllabus: Chemistry 350 / Fall 2017}{}{\sffamily\thepage}
...
\end{tabular} \\[0.09in]
Review meetings may occasionally be offered on Wednesday evenings from 7:00~p.m.\ to 8:30~p.m. Attendance at review meetings is optional. 
%
% --- WEBSITE ---
%
\section{Website}
The course website can be reached by logging in to OWU's Blackboard site at \href{https://bb.owu.edu}{bb.owu.edu} and navigating to the course named \href{https://bb.owu.edu/webapps/blackboard/execute/launcher?type=Course&id=_20014_1&url=}{2017FALLCHEM3501}. The website is an important extension of the syllabus and should be read carefully. 
%
% --- PREREQUISITES ---
%
...
Each of the two weekly course meetings is 110 minutes in length, requiring a total of 3.67 hours per week. Review meetings will, occasionally, add another hour per week. For each regular class meeting you can expect to spend about 4 hours outside of class reading, studying, and working exercises. 
%
% --- CONTENT ---
%
\section{Content}
...
A micro exam is given at the start of a class meeting. Exact dates are in the course schedule. You are given $50$ minutes to complete a micro exam. The topics covered on each micro exam are listed in the course schedule. Solutions to micro exams are posted on the course website after they are graded. Each micro exam is worth 50 points.
%
% --- Exams ---
%
\subsection{Exams}
There are two exams during the semester. All exams are cumulative. Solutions for exams are posted on the course website after all exams are graded. See the course website for the exam schedule. Each exam is weighted equally at 150 points each. 
%
% --- Final Exam ---
%
...
Each topic is accompanied by a set of practice exercises. These exercises are recommended, but I never collect and grade them. It is essential that you work (or at least review) as many of the practice exercises as possible. Solutions for practice exercises are available on the course website. 
%
% --- COURSE SCORE ---
%
\section{Course Score}
Your \marginnote{-0.1in}{Weights of Evaluations \\ Micro Exams: \(35\%\) \\ Exams: \(35\%\) \\ Final Exam: \(30\%\)}course score is a weighted average of the scores you earn on micro exams and exams. These scores are weighted at \(35\%\) for micro exams, \(35\%\) for exams, and \(30\%\) for the final exam.  
%
% --- LETTER GRADE ---
%
