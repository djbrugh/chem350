%----------------------------------------------------------------------------
% Course Syllabus for Chemistry 350 (c) 2015 by Dale J. Brugh
...
\hypersetup{
    ...
    pdfkeywords={classes, ch350f15}, % list of keywords
...
\makeoddhead{courseinformation}%
    {\sffamily Course Syllabus: Chemistry 350 / Fall 2015}{}{\sffamily\thepage}
...
\end{tabular} \\[0.09in]
Review meetings are scheduled on Wednesday evenings from 7:30~p.m.\ to 9:00~p.m. Attendance at review meetings is optional but strongly encouraged. 
%
% --- WEBSITE ---
%
\section{Website}
...
%
\subsection{Quizzes}
Quizzes \marginnote{-0.1in}{Quizzes are delivered through my Moodle site. Account information will be emailed to you.} are online assessments of comprehension that provide immediate feedback. They are typically given after lecture meetings, but they may also be associated with suggested readings, suggested video micro lectures, exercise assignments, problem sets, or exams. They should take no more than fifteen minutes to complete, and they involve little math. \marginnote{-0.1in}{Two to four quizzes will be given each week.} Check the Moodle website for the quiz schedule. Your lowest eight (8) quiz scores are dropped before computing your final course score. 
%
...
Quizzes & 10\% & Micro Exams & 15\% \\
Exercise Assignments & 15\% & Exams & 25\% \\
Problem Sets & 15\% & Final Exam & 20\% \\ 
\hline\hline
\end{tabular}
\end{table}
%
